...
-- Trigger to automatically update monthly stats when new registration is added
DELIMITER $$
...
BEGIN
    ...
    INSERT INTO monthly_stats (year, month, total_registrations, total_revenue, state_team_count, backup_team_count, student_count)
    VALUES (
        reg_year,
        reg_month,
        1,
...
INSERT INTO registrations (
    ...
    parent_name, parent_ic, payment_amount, payment_date, form_date
) VALUES (
    'WSA2026-0001',
    'John Tan',
    '陈小明',
