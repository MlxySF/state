...
try {
    ...
    // Description with Chinese characters
    ...
    $descriptionText = implode('<br>', $allLines);
    ...
    $html .= '<div class="notes">Registered Routines: ' . $chineseEvents . '</div>';
    $html .= '<div class="notes">Schedule: ' . $cleanSchedule . '</div>';
