...
<div id="pdf-preview-template-page1" style="width: 794px; padding: 40px; background: #ffffff; position: fixed; top: -10000px; left: -10000px; visibility: hidden; pointer-events: none; color: #111827; font-family: 'Noto Sans SC', sans-serif;">
    ...
    <div style="margin-bottom:22px;">
        ...
        <div style="border:1px solid #e5e7eb; border-top:none; padding:10px 12px; font-size:13px; line-height:1.5;">
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Name 姓名:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-name"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">IC No 身份证:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-ic"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Age 年龄:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-age"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">School 学校:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-school"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Status 身份:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-status"></span></div>
        </div>
    </div>
    ...
    <div style="margin-bottom:22px;">
        ...
        <div style="border:1px solid #e5e7eb; border-top:none; padding:10px 12px; font-size:13px; line-height:1.5;">
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Phone 电话:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-phone"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Email 邮箱:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-email"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Level 等级:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-level"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Events 项目:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-events"></span></div>
            <div style="margin-bottom:5px;"><span style="font-weight:600; color:#6b7280; display:inline-block; width:140px;">Schedule 时间:</span> <span style="font-weight:500; color:#111827;" id="preview-pdf-schedule"></span></div>
        </div>
    </div>
    ...
    <div style="font-size: 11px; line-height: 1.5; color: #111827; font-family: 'Noto Sans SC', sans-serif;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">本人同意遵守学院及教练设定的所有指示、规则和安排。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">仅在学院取消课程时提供补课，家长不得自行取消课程。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">若学员因病或其他原因无法出席，须向管理员和教练申请请假，未经批准的缺席将被记录。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">州队及后备队运动员必须出席所有训练，保持良好态度，并接受严格的训练及纪律。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">有伤病的学员不宜参加训练，任何后果自负。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">学院不负责任何属于学员或家长的贵重物品。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">打架、吵架、态度不佳或拒绝配合训练可能导致被开除州队及学院。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">训练期间不得进食，只允许在休息时间喝水。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">家长不得干涉教练设定的专业训练计划或纪律。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">家长必须准时接送孩子，并对交通安全负全责。</p>
            ...
            <tr>
                ...
                <td style="padding: 0 0 8px 0;">
                    <p style="margin: 0 0 2px 0; font-weight: 600; font-size: 11px; line-height: 1.4;">训练过程可能被录像或拍照用于宣传，不同意的家长须书面通知学院。</p>
        ...
        <div style="margin-top: 18px; padding: 14px 16px; background: #f8fafc; border: 2px solid #1e293b; border-radius: 6px;">
            ...
            <p style="color: #4b5563; font-size: 10px; margin: 0 0 10px 0; line-height: 1.5;">
                签署本文件即表示家长/监护人已阅读、理解并同意以上所有15项条款与条件。
            </p>
